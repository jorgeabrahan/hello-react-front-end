...
- **Connection with rails backend API**
...
```
git clone https://github.com/jorgeabrahan/hello-react-front-end.git
```
...
Project idea is from [Microverse](https://github.com/microverseinc/curriculum-rails/blob/main/connect-frontend-frameworks/hello_world_two_apps.md)
...
- **What is this project main purpose?**
  ...
  - To practice working with React, Redux, Routers, Async Thunks and connecting the app with a Rails backend API.
